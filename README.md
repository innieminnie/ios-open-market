...
> <br> 네트워크 호출을 통해 ( REST API ) <br><br>(1) 마켓 서버에 있는 전체 상품 목록을 가져와 정보를 화면에 표시합니다.<br><br>(2) 상품을 탭할 경우, 상품의 구체적인 정보를 화면에 표시합니다.<br><br>
...
- Protocol Oriented Programming
  - [:thinking: 데이터 요청 1번을 통해 다수의 뷰컨트롤러에 같은 데이터를 전달할 순 없을까?](#thinking-데이터-요청-1번을-통해-다수의-뷰컨트롤러에-같은-데이터를-전달할-순-없을까)
...
---
## 3) 프로토콜 지향적인 리팩토링
### :thinking: 네트워크 요청 1번을 통해 다수의 뷰컨트롤러에 같은 데이터를 전달할 순 없을까?
- 기존 방식:<br>
